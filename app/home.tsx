...
const styles = StyleSheet.create({
  ...
  incomeAmount: { color: theme.color.text, fontSize: 17, fontWeight: "850" },
  expenseAmount: { color: theme.color.text, fontSize: 17, fontWeight: "850" },
  ...
  ledgerCategory: { color: theme.color.text, fontSize: 16, fontWeight: "850" },
  ledgerMeta: { color: theme.color.textMuted, fontSize: 12, fontWeight: "650" },
