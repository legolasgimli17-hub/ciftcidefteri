...
.ec-fieldBadge{display:inline-flex;align-items:center;gap:6px;font-size:11px;font-weight:850;color:#173f30;background:#edf6f0;border:1px solid #bad1c3;border-radius:999px;padding:7px 10px}.ec-fieldBadge:before{content:'';width:7px;height:7px;border-radius:50%;background:#2d7a59}.ec-debtSource{margin-top:10px}
...
function run(){replaceBrandText();decorateStatus();applyCropAwareCategories();enhanceDebtSource();installDebtCapture();}
