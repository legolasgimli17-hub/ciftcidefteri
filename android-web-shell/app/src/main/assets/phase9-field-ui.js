...
function loadNativeShell(){if(location.protocol!=='file:'||window.__EKINCEP_PHASE11_NATIVE_SHELL__||document.getElementById('ekincepPhase11Loader'))return;const s=document.createElement('script');s.id='ekincepPhase11Loader';s.src='phase11-app-shell.js';s.async=false;s.onerror=()=>{try{toast('Yeni arayüz yüklenemedi. Uygulamayı yeniden aç.')}catch{}};document.head.appendChild(s);}
